...
<div class="album-grid">
    ...
    <div class="album-card">
       ...
       <a href="View/customer/.php?category=scrapbook" class="btn-card">View items</a> 
    </div>
    ...
    <div class="album-card">
        ...
        <a href="View/customer/.php?category=explosion_box" class="btn-card">View items</a>
    </div>
...
<div class="album-card">
        ...
        <a href="View/customer/.php?category=popup_card" class="btn-card">View items</a>
    </div>
    ...
    <div class="album-card">
        ...
        <a href="View/customer/.php?category=nikah_pen" class="btn-card">View items</a>
    </div>
    ...
    <div class="album-card">
        ...
        <a href="View/customer/.php?category=bouquet" class="btn-card">View items</a>
    </div>
    ...
    <div class="album-card">
        ...
        <a href="View/customer/.php?category=frame" class="btn-card">View items</a>
    </div>
    ...
    <div class="album-card">
        ...
        <a href="View/customer/.php?category=hamper" class="btn-card">View items</a>
    </div>
    ...
    <div class="album-card">
        ...
        <a href="View/customer/.php?category=shadow_box" class="btn-card">View items</a>
    </div>
    ...
    <div class="album-card">
        ...
        <a href="View/customer/.php?category=illustration" class="btn-card">View items</a>
    </div>
