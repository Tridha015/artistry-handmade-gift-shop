...
$username = $_SESSION["loggedInUsername"] ?? "Nafisa Ali";
?>

<style>
    .profile-banner { width: 80%; margin: 25px auto; background: #ffffff; padding: 25px 30px; border: 1px solid #dddddd; border-radius: 4px; display: flex; align-items: center; gap: 20px; }
    ...
    .form-container { width: 80%; margin: 0 auto 40px auto; background: #ffffff; padding: 30px; border: 1px solid #dddddd; border-radius: 4px; }
    ...
    <form action="../../Controller/profileUpdateController.php" method="POST">
        ...
        <div class="input-row">
            ...
            <div class="input-half input-half-right">
                ...
                <input type="email" name="email" value="nafisa.ali@gmail.com" required>
            </div>
        </div>
        ...
        <div class="input-row">
            <div class="input-half">
                ...
                <input type="text" name="phone" value="01711-234567" required>
            </div>
            <div class="input-half input-half-right">
        ...
        <div class="input-row" style="clear: both;">
            ...
            <textarea name="address" rows="3" required>House 14, Road 27, Dhanmondi, Dhaka - 1209</textarea>
        </div>
        ...
        <div class="btn-group" style="clear: both;">
            <a href="dashboard.php" class="btn-back">Back to Orders</a>
