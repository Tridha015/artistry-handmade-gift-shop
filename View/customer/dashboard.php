...
<div style="max-width: 1000px; margin: 30px auto; font-family: sans-serif; padding: 0 20px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; border-bottom: 2px solid #eee; padding-bottom: 15px;">
        <div>
            <h2 style="margin: 0; color: #341946;">My Orders & Custom Requests</h2>
            <p style="margin: 5px 0 0 0; color: #666;">Welcome back, <strong><?php echo htmlspecialchars($_SESSION['user_name'] ?? 'Customer'); ?></strong></p>
        </div>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="6" style="text-align: center; color: #888; padding: 30px;">
                        You haven't placed any orders or custom craft requests yet.<br><br>
                        <a href="custom_order.php" style="background-color: rgb(87, 37, 83); color: white; padding: 8px 14px; text-decoration: none; border-radius: 4px; font-size: 13px;">Request a Custom Craft</a>
                    </td>
                </tr>
            <?php endif; ?>
        </tbody>
